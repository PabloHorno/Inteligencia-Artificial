...
namespace mochila
{
	...
	{
		//Completar
		//Se ordenan de menor a mayor según valor específico dado que la ordenacion estatica elige siempre desde el final
	...
	double Mochila::cota_superior_mochila_fraccional()
	{
		...
		//Las variables se suponen ordenadas de menor a mayor según valor específico

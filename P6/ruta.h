...
namespace ruta
{
    ...
    public:
        Ruta()
        {
            // Obtención de semilla para generadores de aleatorios
        ...
        void inicializa_ruta(ciudades::Ciudades&&ciu)
        {
			...
			aleatorio_num_ciudades_mas_1 = std::uniform_int_distribution<unsigned>(0, num_ciudades);
    ...
    private:
		...
		std::uniform_int_distribution<unsigned> aleatorio_num_ciudades_mas_1;
		...
		void mover_segmento(const unsigned p1, const unsigned p2, const unsigned p3);
    };

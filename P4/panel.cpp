...
void Panel::inicializa(unsigned ancho,unsigned alto,unsigned ancho_panel)
{
    ...
    texto_boton_ordenador.setString("Ordenador");
    ...
    texto_boton_manual.setString("Manual");
    texto_boton_manual.setPosition(ancho-ancho_panel+50,alto-55);
    texto_boton_manual.setFillColor(sf::Color::Black);

    texto_etiqueta_turno.setFont(font);
    texto_etiqueta_turno.setString("Turno actual:");
    ...
    texto_etiqueta_puntuacion.setString("PUNTUACION");

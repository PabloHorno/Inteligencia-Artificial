//Cargamos los parámetros del algoritmo genetico
template<typename T>
...
void Genetico_Tsp<T>::ejecutar(T& individuo)
{
    ...
    //Ordenamos la población por orden de puntuación
    ...
    for(unsigned i=0; i!=num_generaciones; ++i)
    {
        ...
        while(poblacion_nueva.size()!=num_individuos)
        {
            ...
            //Alumno ---> Asegura que no estén repetidos
			do
			{
            ...
            //CRUCE
            //El cruce genera una lista de hijos, típicamente 1 o 2
            ...
            //MUTACION
            for(auto &h:hijos) //Al compilar inicialmente dará error pues hijos no está creada
            {
        ...
        //Alumno ---> ordena por puntuacion la poblacion. Así nos aseguramos que poblacion[0]
        //Alumno ---> es nuestro mejor individuo y accedemos fácilmente a la elite
...
void Genetico_Tsp<T>::crea_poblacion_inicial(T& individuo)
{
    ...
    do
    {
        ...
        //Verificamos que no está repetido
